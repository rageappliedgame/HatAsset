...
namespace TwoA
{
    ...
    internal class DifficultyAdapter
    {
        ...
        private double calcTargetBeta(double theta) { // [SC][2016.01.07] "TargetBeta" => "calcTargetBeta"
            ...
            // return theta + Math.Log(randomNum / (1 - randomNum)); // [SC][2016.10.07]
            return theta + Math.Log((1 - randomNum) / randomNum); // [SC][2016.10.07] a modified version of the equation from the original data; better suits the data
        }
